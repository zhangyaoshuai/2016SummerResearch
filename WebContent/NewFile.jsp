...
<body id="page-top" class="index">
	<div class="container-fluid" style="height: 100%; margin-top: 0px">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul id="navigate" class="nav navbar-nav navbar-right">
					...
					<li class="dropdown" style="margin-left: 0"><a href="#"
					class="dropdown-toggle page" data-toggle="dropdown"
					style="color: #0099cc"> My <b>List</b><span class="caret"></span></a>
					<ul id="" class="dropdown-menu">
						<li style="color: #0099cc"><form action="/" method="post">
								...
								<button type="submit" class="btn btn-link"
									style="color: #0099cc">House Lists</button>
							</form></li>
						<li style="color: #0099cc"><form action="/" method="post">
								<input type=hidden id="hidden 1" name="email"
									value="<%=request.getParameter("Email")%>">
								<button type="submit" class="btn btn-link"
									style="color: #0099cc">Item Lists</button>
							</form></li>
							<li style="color: #0099cc"><form action="/FindUserHouseCL"
									...
									<input type=hidden id="hidden 1" name="email"
										value="<%=request.getParameter("Email") %>">
									<button type="submit" class="btn btn-link"
										style="color: #0099cc">Update Lists</button>
								</form></li>
					</ul></li>
					...
					<li role="presentation">
						<div class="dropdown">
							<button class="btn btn-lg btn-info btn-block dropdown-toggle"
								...
								style="height: auto; max-width: 160px; padding: 2">
							...
							<ul class="dropdown-menu">
								<li style="color: #0099cc"><form action="/addWish.jsp"
										...
										<input type=hidden id="hidden 1" name="email"
											value="<%=request.getParameter("Email") %>">
										<button type="submit" class="btn btn-link"
											style="color: #0099cc">Hosue rentals</button>
									</form></li>
								<li style="color: #0099cc"><form action="/" method="post">
										<input type=hidden id="hidden 1" name=email
											value="<%=request.getParameter("Email") %>">
      ...
      <ul id="login-dp" class="dropdown-menu">
              ...
              <div class="bottom text-center">
                New here ? <a href="/signup.jsp"><b style="color:#0099cc">Join Us</b></a>
					...
					<li role="presentation" style="margin-left: 0"><a
						href="/index.jsp" style="color: #0099cc" class="page">Logout</a></li>
		...
		<!--<section id="services" style="margin-top:0">-->
		<section>
